...
export const intelData: MacModel[] = [
  ...
  
  {
    ...
    os: 'macOS Monterey',
    cores_cpu: '4',
    cores_gpu: 0, // Iris Pro
    memory: '16GB',
    ramType: '1600MHz DDR3L',
    displayInfo: '15.4" Retina',
    releaseYear: 2015,
    singleCoreScore: 950,
    multiCoreScore: 3600,
    metalScore: 2500,
    basePriceUSD: 2499,
    description: 'The "Legendary" MBP. The last one with all the ports (USB-A, HDMI, SD) and the MagSafe 2 before the butterfly era.'
  },
  {
    id: 'intel-mbp-13-2015-i5',
    ...
    metalScore: 1800,
    basePriceUSD: 1299,
    description: 'A reliable workhorse that many users held onto for years.'
  },
  {
    id: 'intel-macpro-2013-12core',
    ...
    os: 'macOS Monterey',
    cores_cpu: '12',
    cores_gpu: 12, // Dual FirePro D700
    memory: '16GB - 128GB',
    ramType: '1866MHz DDR3 ECC',
    displayInfo: 'N/A (Headless)',
    releaseYear: 2013,
    singleCoreScore: 750,
    multiCoreScore: 6800,
    metalScore: 32000,
    basePriceUSD: 6999,
    description: 'The "Trash Can" Mac Pro. Beautiful design, but thermal limitations hampered its longevity.'
  },
  {
    id: 'intel-imac-27-2015-5k',
    name: 'iMac 27" (Late 2015)',
    type: DeviceType.Desktop,
    chip: 'Core i7-6700K',
    family: ChipFamily.Intel,
    os: 'macOS Monterey',
    cores_cpu: '4',
    cores_gpu: 4, // Radeon R9 M395X
    memory: '8GB - 64GB',
    ramType: '1867MHz DDR3',
    displayInfo: '27" 5K Retina (P3)',
    releaseYear: 2015,
    singleCoreScore: 1100,
    multiCoreScore: 4200,
    metalScore: 18000,
    basePriceUSD: 2299,
    description: 'The first iMac with a P3 wide color gamut display.'
  },
  {
