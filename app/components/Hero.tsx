    ...
    <div id="hero-section" className="relative text-center space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-1000 pb-8 overflow-hidden">
       ...
       {onShare && (
         <div className="flex justify-center pt-2">
            <button
              onClick={onShare}
              className="group flex items-center gap-2 px-8 py-3 rounded-full bg-black dark:bg-white text-white dark:text-black font-bold shadow-2xl hover:scale-105 active:scale-95 transition-transform duration-300"
            >
