  ...
  return (
    <html lang="en" className={`${inter.variable} ${jetbrainsMono.variable}`} suppressHydrationWarning>
      <head>
        ...
        {/* Primary Meta Tags */}
        <title>MacRank 2025: 苹果电脑性能天梯榜 v0.7.6</title>
        <meta name="title" content="MacRank 2025: 苹果电脑性能天梯榜 v0.7.6" />
        <meta name="description" content="最全的苹果电脑性能天梯查询表。包含 AI 选购助手、硬件深度对比、Geekbench 6 跑分与性价比分析。版本: 0.7.6" />
        ...
        <meta property="og:title" content="MacRank 2025: Mac 性能天梯榜 v0.7.6" />
