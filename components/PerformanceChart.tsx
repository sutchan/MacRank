    ...
    return (
      <div className="bg-white dark:bg-gray-800 p-3 border border-gray-100 dark:border-gray-700 shadow-lg rounded-xl text-xs transition-colors">
        ...
        <div className="space-y-1">
          <p className="text-blue-600 dark:text-blue-400 font-medium">Multi-Core: {data.multiCoreScore}</p>
          <p className="text-purple-600 dark:text-purple-400 font-medium">Metal (GPU): {data.metalScore}</p>
...
const PerformanceChart: React.FC<PerformanceChartProps> = ({ data }) => {
  ...
  return (
    <div className="w-full h-[400px] bg-white dark:bg-gray-900 p-4 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800 transition-colors">
      <h3 className="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-4 ml-2">Top 15 Performance Index</h3>
