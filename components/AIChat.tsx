...
const AIChat: React.FC<AIChatProps> = ({ macData }) => {
  ...
  return (
    <>
      ...
      <div 
        className={`fixed bottom-6 right-6 z-50 w-[90vw] sm:w-[380px] h-[600px] max-h-[80vh] bg-[rgba(255,255,255,0.85)] dark:bg-[rgba(30,30,30,0.85)] backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 dark:border-white/10 flex flex-col transition-all duration-500 transform origin-bottom-right overflow-hidden ${
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          ...
          {isLoading && (
            <div className="flex justify-start">
               <div className="bg-gray-200 dark:bg-gray-700 rounded-2xl rounded-bl-none px-4 py-3 flex gap-1 items-center">
        ...
        <form onSubmit={handleSubmit} className="p-4 bg-transparent">
          <div className="relative flex items-center bg-gray-100 dark:bg-gray-800 rounded-full border border-gray-200 dark:border-gray-700 px-1 py-1 focus-within:ring-2 focus-within:ring-blue-500/50 transition-all">
            <input
              type="text"
              value={input}
