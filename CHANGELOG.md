...
### Changed
- **UI/UX Overhaul**: Redesigned and simplified the Filter Controls bar.
  - Merged two rows of controls into a single, cleaner toolbar.
  - Converted "Use Case Scenarios" from a button group into a space-saving dropdown menu.
  - Grouped "Sort By" and "PC/GPU Reference" toggle into a new "View Options" popover to declutter the main interface.
  - Improved layout, spacing, and visual hierarchy for a more intuitive user experience.

## [0.3.4] - 2025-02-22

### Added
- **Expanded Database**: Added speculative data for the next-generation **M5 Chip Family** (M5, M5 Pro, M5 Max) across MacBook Pro and Mac Studio lines for future-proofing.
- **Updated Scoring**: Adjusted performance normalization ceilings to accurately rank the new top-tier M5 chips.
